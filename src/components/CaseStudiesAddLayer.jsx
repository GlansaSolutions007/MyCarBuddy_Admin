...
const CaseStudiesAddLayer = ({ setPageTitle }) => {
  ...
  useEffect(() => {
    setPageTitle(isEditing ? "Edit - Case Study" : "Add - Case Study");
    fetchCategories();
    fetchSubCategories();
    fetchIncludes();
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data" className="row g-3">
            <div className='row'>
              <div className='col-sm-6 mt-2'>
                <label className='form-label text-sm fw-semibold text-primary-light mb-8'>Case Study Title<span className='text-danger-600'>*</span></label>
                <input
                  type='text'
                  name='PackageName'
              ...
              <div className='col-sm-6 mt-2'>
                <div className='mb-10'>
                  <label className='form-label text-sm fw-semibold text-primary-light mb-8'>
                    Select Vehicle Name <span className='text-danger-600'>*</span>
                  </label>
                  <Select
                    name='SubCategoryID'
                    options={filteredSubCategories
              ...
              <div className='col-sm-6 mt-2'>
                <div className='mb-10'>
                  <label className='form-label text-sm fw-semibold text-primary-light mb-8'>
                    Before Service Condition <span className='text-danger-600'>*</span>
                  </label>
                  <Select
                    name='SubCategoryID'
                    options={filteredSubCategories
              ...
              <div className='col-sm-6 mt-2'>
                <div className='mb-10'>
                  <label className='form-label text-sm fw-semibold text-primary-light mb-8'>
                    After Service Condition <span className='text-danger-600'>*</span>
                  </label>
                  <Select
                    name='SubCategoryID'
                    options={filteredSubCategories
              ...
              <div className="col-md-6">
                <label className='form-label text-sm fw-semibold text-primary-light mb-8'>Service Duration (Minutes)</label>
                <input
                  type="number"
              ...
              <div className="col-md-6">
                <label className='form-label text-sm fw-semibold text-primary-light mb-8'>Amount Saved (₹)</label>
                <input
                  type="number"
                  name="Default_Price"
                  className="form-control"
              ...
              <div className="col-md-6">
                <label className='form-label text-sm fw-semibold text-primary-light mb-8'>Rating (0–5)</label>
                <input
                  type="number"
              ...
              <div className='col-sm-6 mt-2'>
                <label className='form-label fw-semibold text-primary-light'>Case Study Image (Before)</label>
              ...
              <div className='col-sm-6 mt-2'>
                <label className='form-label fw-semibold text-primary-light'>Case Study Image (After)</label>
                <input type='file' accept='image/*' className='form-control' onChange={handleImageChange} />
                {packageImagePreview && (
                  <div className='mt-2'>
                    <img src={packageImagePreview} alt='Preview' width={120} className='rounded' />
              ...
              <div className='d-flex justify-content-center gap-3 mt-24'>
                <button type='submit' className='btn btn-primary-600 radius-8 px-14 py-6 ' disabled={isSubmitting}>
                  {isSubmitting ? "Submitting..." : isEditing ? "Update" : "Save"} Case Study
                </button>
                <button
                  type="button"
...
export default CaseStudiesAddLayer;
