...
const ServiceSubCategories2Layer = () => {
  ...
  const API_BASE = `${import.meta.env.VITE_APIURL}SubCategory2`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.SubCategoryID) {
        ...
        res = await axios.put(`${API_BASE}/UpdateSubCategory2`, form, { headers });
      } else {
        form.append("CreatedBy", UserId);
        res = await axios.post(`${API_BASE}/AddSubCategory2`, form, { headers });
      }

      const data = res.data;
      if (data.status) {
        Swal.fire("Success", "Service Category saved successfully", "success");
      } else {
          ...
          <div className="card h-100 p-0">
            <div className="card-body p-24">
              <form onSubmit={handleSubmit} className="form" noValidate>
                <div className="mb-10">
                  <label className='text-sm fw-semibold text-primary-light mb-8'>Sub Category Name</label>
                  <input
                    type="text"
                ...
                <div className="mb-10">
                  <label className='text-sm fw-semibold text-primary-light mb-8'>Description</label>
                  <textarea
                    name="Description"
                ...
                <div className="mb-3">
                  <label className='text-sm fw-semibold text-primary-light mb-8'>Icon Image (40x40)</label>
                  <input type="file" accept="image/*" className={`form-control ${errors.IconImage1 ? "is-invalid" : ""}`} onChange={(e) => handleImageChange(e, "icon")} />
                  {iconPreview && (
                    <div className="mt-2">
                ...
                <div className="mb-3">
                  <label className='text-sm fw-semibold text-primary-light mb-8'>Thumbnail Image</label>
                  <input type="file" accept="image/*" className={`form-control ${errors.ThumbnailImage1 ? "is-invalid" : ""}`} onChange={(e) => handleImageChange(e, "thumbnail")} />
                  {thumbnailPreview && (
                    <div className="mt-2">
...
export default ServiceSubCategories2Layer;
